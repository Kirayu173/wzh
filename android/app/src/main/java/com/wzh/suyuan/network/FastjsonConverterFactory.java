...
public class FastjsonConverterFactory extends Converter.Factory {
    ...
    final class ResponseBodyConverter<T> implements Converter<ResponseBody, T> {
        ...
        public T convert(ResponseBody value) throws IOException {
            try {
                return JSON.parseObject(value.string(), type, parserConfig, featureValues,
    ...
    final class RequestBodyConverter<T> implements Converter<T, RequestBody> {
        ...
        public RequestBody convert(T value) {
            byte[] content = JSON.toJSONBytes(value,
                    serializeConfig == null ? SerializeConfig.globalInstance : serializeConfig,
                    serializerFeatures == null ? SerializerFeature.EMPTY : serializerFeatures);
